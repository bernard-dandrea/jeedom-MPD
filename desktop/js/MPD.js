...
$('#bt_TestConnexionMPD').on('click', function () {
    $.ajax({// fonction permettant de faire de l'ajax
        type: "POST", // methode de transmission des données au fichier php
        url: "plugins/MPD/core/ajax/MPD.ajax.php", // url du fichier php
        // LA FONCTION test_connexion DOIT ETRE DEFINIE DANS LE FICHIER CI-DESSUS
        data: {
...
$('#bt_Generer_Commandes').on('click', function () {
    $.ajax({// fonction permettant de faire de l'ajax
        type: "POST", // methode de transmission des données au fichier php
        url: "plugins/MPD/core/ajax/MPD.ajax.php", // url du fichier php
        // LA FONCTION bt_Generer Commandes DOIT ETRE DEFINIE DANS LE FICHIER CI-DESSUS
        data: {
...
$("#bt_create_command").on('click', function (event) {
